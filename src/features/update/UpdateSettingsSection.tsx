...
function UpdateToggleRow({ label, checked, disabled = false, onChange }: UpdateToggleRowProps) {
  return (
    <button
      ...
      className={`w-full flex items-center justify-between h-9 rounded-lg px-2.5 bg-paper-warm/45 border border-paper-deep/25 outline-none focus-visible:ring-2 focus-visible:ring-bamboo/35 ${
